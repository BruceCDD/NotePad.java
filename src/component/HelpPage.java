...
public class HelpPage extends JFrame{
    public HelpPage() {
        ...
        JLabel label3 = new JLabel("3、文本查看支持：查找与替换（支持快捷键Ctrl + f）、自动换行、字体大小设置、暗黑模式");
        JLabel label4 = new JLabel("4、字数统计支持：实时的中英文字数统计");
        JLabel label5 = new JLabel("5、感谢您的使用，祝您使用愉快！");
